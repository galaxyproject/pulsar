...
class HTCondorQueueManager(ExternalBaseManager):
    ...
    def __init__(self, name, app, **kwds):
        ...
        self.collector = kwds.get("htcondor_collector")
        self.schedd_name = kwds.get("htcondor_schedd")
        self.condor_config = normalize_condor_config(kwds.get("htcondor_config"))
        self.request_walltime = kwds.get("request_walltime")

...
sudo apt-get install slurm-wlm slurm-wlm-torque # slurm-drmaa1 slurm-drmaa-dev
sudo apt-get install libswitch-perl  # A missing dependency of slurm-llnl-torque
wget https://depot.galaxyproject.org/old/deb/slurm-drmaa1_1.2.0-dev.57ebc0c_amd64.deb
sudo dpkg -i slurm-drmaa1_1.2.0-dev.57ebc0c_amd64.deb
wget https://depot.galaxyproject.org/old/deb/slurm-drmaa-dev_1.2.0-dev.57ebc0c_amd64.deb
